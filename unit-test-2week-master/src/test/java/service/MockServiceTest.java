...
public class MockServiceTest {
    ...
    public void 챔피언이름을가져오면_무조건_카이사를_리턴한다() {
        ...
        champion.setName("르블랑"); // 실제 값이 setting되지 X
...
//        System.out.println("챔피언 이름: "+champion.getName());
    ...
    @Test
    public void shouldReturnValueWhenAnythingInputName(){
        Champion champion = mock(Champion.class);
    ...
    public void shouldOneTimeRunForChampionArraySize(){
        ...
        System.out.println("size :: "+ mockChampions.size()); // 0 => 가짜 객체이므로 값이 없음
    ...
    public void List객체사이즈검증테스트(){
        ...
        champions.add(new Champion("dnelfm", "정글", 3));
        champions.add(new Champion("레오나", "서포터", 5));
    ...
    @Test
    public void 탐켄치를_호출하면_탐켄치정보를_리턴하고_1번이하로_호출되었는지_테스트() {
        //given
